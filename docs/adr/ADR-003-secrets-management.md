...
## Rollout Plan
### Definition of Done
- [x] Создан .env.example с описанием required переменных
- [x] JWT_SECRET и DATABASE_URL загружаются из окружения
- [x] Настроена валидация обязательных переменных при старте
- [x] Документация по настройке окружения
