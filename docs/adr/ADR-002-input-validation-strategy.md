...
## Rollout Plan
### Definition of Done
- [ ] Все Pydantic схемы имеют field_validator для санитизации
- [ ] Тесты покрывают граничные значения и инъекции
- [ ] Валидация веса (0.1-500kg) и повторений (1-100)
- [ ] HTML экранирование для текстовых полей
